...
class StockOrderAggregateListAdapterTest {
    ...
    fun setUp() {
        ...
        StockPriceRepository.put(setOf(
                StockPrice(StockPrice.SYMBOLS[0].first, Currency.getInstance(StockPrice.SYMBOLS[0].third), 100.0),
                StockPrice(StockPrice.SYMBOLS[1].first, Currency.getInstance(StockPrice.SYMBOLS[1].third), 0.02),
                StockPrice(StockPrice.SYMBOLS[2].first, Currency.getInstance(StockPrice.SYMBOLS[2].third), 0.01),
        ))
        ...
        val list: List<AdapterItem> = listOf(
                ...
                StockAggregateAdapterItem(getSimpleStockAggregate(StockPrice.SYMBOLS[1].first,
                        StockPrice.SYMBOLS[1].third, 0.0199)),
                StockAggregateAdapterItem(getSimpleStockAggregate(StockPrice.SYMBOLS[2].first,
    ...
    private fun getSimpleStockAggregate(
        ...
        stockOrderAggregate.aggregate(StockOrder("Buy", currencySymbol, 0,
